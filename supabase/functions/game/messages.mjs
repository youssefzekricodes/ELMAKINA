...
const log = {
  en: {
    ...
    'colonel.wrong': 'Wrong! {target} does not hold a {guess}. {name} loses the 4 coins to {target} ({gain}).',
    'colonel.right.fell': 'Correct! {target} really held a {guess} — and already lost it to the challenge. The 4 coins go to the bank.',
  ...
  tn: {
    ...
    'colonel.wrong': 'غالط! {target} ما عندوش {guess}. {name} خسر الـ4 دينار و مشاو لـ {target} ({gain}).',
    'colonel.right.fell': 'صحيح! {target} كان عندو {guess} بالحقّ — و خسرها من قبل في التحدّي. الـ4 دينار مشاو للبنكة.',
