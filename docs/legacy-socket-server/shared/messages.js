/* Shared message catalog (server + client). Log entries carry {key, params}; text is rendered per language.
   Languages: en (English), tn (Tunisian Derja, Arabic script). */
(function (root, factory) {
  if (typeof module === 'object' && module.exports) module.exports = factory();
  else root.MEKINA_MESSAGES = factory();
  ...
  return { names, reasons, whats, log, format, gainStr, LANGS: ['en', 'tn'] };
});
